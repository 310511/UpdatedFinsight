...
const ReportsViewer = ({ reports, documentType, baseResult = null }) => {
  ...
  const renderReportContent = (reportName, reportData) => {
    ...
    if (reportName === 'accounting_ratios') {
      ...
      const companyName = reportData.company_name || reportData.companyName || baseResult?.company_name || 'Company Name';
    ...
    <div className="space-y-4">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="p-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500 mt-1">Click on any report to view details</p>
        </div>
            ...
            if (filteredReports.length === 0) {
              return (
                <div className="p-4 text-center text-gray-500">
                  No reports available for this document type.
                </div>
              );
            }
            
            return filteredReports.map(([reportName, reportData]) => {
              ...
              return (
                <div key={reportName} className="transition-colors hover:bg-gray-50">
                  <button
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          {reportData.error ? 'Error generating report' : 'Click to view details'}
                        </p>
                      </div>
                    </div>
                    {isExpanded ? (
